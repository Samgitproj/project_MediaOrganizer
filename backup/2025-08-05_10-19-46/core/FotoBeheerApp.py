...
class FotoBeheerApp(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Vul combobox filtertypes met vaste waarden
        self.ui_dialog.comboSelectTypeMain.clear()
        self.ui_dialog.comboSelectTypeMain.addItems(["Foto's", "Films", "Beide"])
        ...
        self.ui_dialog.btnSearchAll.clicked.connect(self.start_search_from_location)
