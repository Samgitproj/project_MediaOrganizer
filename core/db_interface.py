...
# [END: FUNC: upsert_media]

# [FUNC: mark_missing_in_folder]
...
# [END: FUNC: mark_missing_in_folder]
...
# [END: FUNC: set_thumbnail]
# [END: SECTION: CLASS: DbService]
